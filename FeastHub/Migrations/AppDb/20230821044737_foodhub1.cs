...
{
    public partial class foodhub1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Menue", x => x.MenuId);
                    table.ForeignKey(
                        name: "FK_Menue_Vendor_VendorId",
                        column: x => x.VendorId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OperatingHour", x => x.OperatingHoursId);
                    table.ForeignKey(
                        name: "FK_OperatingHour_Vendor_VendorId",
                        column: x => x.VendorId,
                        principalTable: "Vendor",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OperatingHour_VendorId",
                table: "OperatingHour",
                column: "VendorId");
        }
